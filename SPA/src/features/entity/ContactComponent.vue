    ...
    <div v-if="!isReadOnly">
      <div class="col-sm-10 input-group">
        ...
        <select v-model="contactPlaceholder.type_tag">
          <option selected />
          <option
            v-for="(option, index) in contactTypes"
            :key="index"
            :value="option"
          >
            {{ option }}
      ...
      <div class="col-sm-10 input-group">
        ...
        <input
          v-model="contactPlaceholder.number"
          type="text"
      ...
      <div class="col-sm-10 input-group">
        ...
        <textarea
          v-model="contactPlaceholder.complement"
          rows="2"
        />
      </div>
      <button
      ...
      <button
        ...
        @click="cleanContactPlaceholder()"
      >
        Limpar
      </button>
    </div>
    <div
      v-for="(item, index) in localContact"
      :key="index"
      class="mb-3 row"
    >
      <div v-if="!isReadOnly">
